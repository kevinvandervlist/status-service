...
export const LIVE_RELOAD_PORT     = argv.reloadport || 4002;
export const DOCS_PORT            = argv.docsport   || 4003;
export const APP_BASE             = argv.base        || "/";

export const APP_TITLE            = "Status service";
...
NPM_DEPENDENCIES
  .filter((d:any) => !/\*/.test(d.src)) // Skip globs
  .forEach((d:any) => d.src = require.resolve(d.src));
